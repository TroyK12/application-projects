...
export default function ShoppingCartBtn({ cart }: ShoppingCartButtonProps) {
        ...
        <div className="dropdown dropdown-end">
            ...
            <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                ...
                <div className="card-actions">
                    <Link href={"/cart"} onClick={closeCartTab} className="btn btn-primary btn-block">View cart</Link>
                </div>
                </div>
            </div>
        </div>
